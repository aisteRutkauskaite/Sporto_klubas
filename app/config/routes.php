...
Router::add('api_pizza_order', '/api/order/create', \App\Controllers\User\API\OrdersApiController::class, 'create');
Router::add('api_user_order_get', '/api/order/user/get', \App\Controllers\User\API\OrdersApiController::class, 'index');
